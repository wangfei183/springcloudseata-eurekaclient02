package com.example.springcloudseataeurekaclient02.mybatisplusutils;
...
//                .setOutputDir("C:\\Users\\EDZ\\Desktop\\生成代码文件") // 生成路径(绝对路径)
        ...
        source.setDbType(DbType.MYSQL)					// 设置数据库类型
                ...
                .setUrl("jdbc:mysql://localhost:3306/seata_account?useUnicode=true&useSSL=false&characterEncoding=utf8&serverTimezone=Hongkong")	// 数据库地址
...
//                .setTablePrefix("tbl_")				// 表前缀
        ...
        packageConfig.setParent("com.example.springcloudseataeurekaclient02") 	// 所有包的父包
                .setEntity("bean")				// 实体类包
